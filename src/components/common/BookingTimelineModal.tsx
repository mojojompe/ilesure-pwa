              ...
              <div className="relative pl-4">
                ...
                {steps.map((step) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-7 h-7 rounded-full border-2 flex items-center justify-center relative z-10 mr-4 shrink-0 bg-background ${isCompleted ? 'border-primary' : isActive ? 'border-accent' : 'border-borderLight'
                        }`}>

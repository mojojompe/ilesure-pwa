            ...
            <div className="flex flex-col items-center px-6">
              ...
              {agent.companyWebsite && (
                <a
                  ...
                  className="flex items-center gap-3 w-full mb-6 p-3 rounded-xl bg-surface border border-borderLight hover:bg-surfaceLight transition-colors"
                >
                  ...
                  <span className="text-sm font-semibold text-primary truncate">{agent.companyWebsite}</span>
                </a>
              )}
